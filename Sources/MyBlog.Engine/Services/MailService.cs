...
namespace MyBlog.Engine.Services
{
    public sealed class MailService
    {
        ...
        /// <summary>
        /// Send plain text mail (use the blog as expeditor)
        /// </summary>
        ...
        /// <returns></returns>
        public Task<Boolean> Send(String toMail, String toName, String subject, String content)
        {
            // Mail send by the blog
            return Send(_options.SendMailFrom, _options.Title, toMail, toName, subject, content);
        }
        ...
        /// <param name="content"></param>
        /// <returns></returns>
        public async Task<Boolean> Send(String fromMail, String fromName, String toMail, String toName, String subject, String content)
        { 
            try
            {
                // Get a new client 
