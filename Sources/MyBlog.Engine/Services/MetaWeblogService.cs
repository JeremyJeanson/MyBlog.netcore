...
namespace MyBlog.Engine.Services
{
    ...
    public sealed class MetaWeblogService
    {
        ...
        // Default Blog Id
        private const string BlogId = "MyBlog";
        ...
        public XDocument Process(XDocument doc)
        {
            ...
            if (String.IsNullOrWhiteSpace(method))
                return ProcessError("Access denied.");
            ...
            switch (method)
            {
                ...
                default: return ProcessError("Method not implemented.");
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static XDocument ProcessError(String message)
        {
                ...
                new XElement(NodeMethodResponse,
                    new XElement(NodeFault,
                        StructValue(
                            ...
                            Member("message", NodeString, message)
                            ))));
        }
        ...
        private XDocument ProcessGetRecentPosts(XDocument doc)
        {
            ...
            if (!Int32.TryParse(arg, out count))
                return ProcessError("Id can't be found.");
        ...
        private XDocument PorcessGetPost(XDocument doc)
        {
            ...
            if (post == null)
            {
                return ProcessError("Post can't be found.");
            }
        ...
        private XDocument ProcessNewPost(XDocument doc)
        {
            ...
            // Return an error
            return ProcessError("Add post is not possible.");
        }
        ...
        private XDocument ProcessEditPost(XDocument doc)
        {
            ...
            // Return an error
            return ProcessError("Update post is not possible.");
        }
        ...
        private XDocument ProcessDeletePost(XDocument doc)
        {
            ...
            // Test if we can parse this arg as integer
            if (!Int32.TryParse(arg, out id))
                return ProcessError("Delete post is not possible.");
        ...
        private XDocument ProcessNewsMediaObject(XDocument doc)
        {
            ...
            // Error
            if (uri == null)
                return ProcessError("Upload is not possible.");
        ...
        private static class DateTime8601
        {
            ...
            internal static bool TryParseDateTime8601(string date, out DateTime result)
            {
